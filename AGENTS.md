...
2. Summarize the changes made in `CURRENT-CHANGES.md` file. Use a format of a brief PR description. Make it very concise. Like 1-2 phrase summary, and then only the most important details.

## Plan Mode

1. Make the plan extremely concise. Sacrifice grammar for the sake of concision.
2. At the end pf each plan, give me a list of unresolved questions to answer, if any.
